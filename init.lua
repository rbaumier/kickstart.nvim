...
-- Put the status bar at the bottom of the screen
vim.opt.cmdheight = 0
vim.opt.ruler = false
...
require('lazy').setup({
...

  {
    ...
    opts = function(_, opts)
      ...
      opts.borderless_telescope = true
      opts.theme = {
        colors = {
          bg = '#000000',
        },
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      --  So, we create new capabilities with nvim cmp/coq, and then broadcast that to the servers.
